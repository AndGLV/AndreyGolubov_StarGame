package ru.golubov.game.screen.game;
...
import ru.golubov.engine.Base2DScreen;
import ru.golubov.engine.Sprite2DTexture;
import ru.golubov.engine.font.Font;
import ru.golubov.engine.math.Rect;
import ru.golubov.engine.math.Rnd;
import ru.golubov.engine.ui.ActionListener;
import ru.golubov.game.Background;
import ru.golubov.game.bullet.Bullet;
import ru.golubov.game.common.EnemiesEmitter;
import ru.golubov.game.explosion.Explosion;
import ru.golubov.game.pool.BulletPool;
import ru.golubov.game.pool.EnemyPool;
import ru.golubov.game.pool.ExplosionPool;
import ru.golubov.game.screen.game.ui.ButtonNewGame;
import ru.golubov.game.screen.game.ui.MessageGameOver;
import ru.golubov.game.ship.Enemy;
import ru.golubov.game.ship.MainShip;
import ru.golubov.game.star.TrackingStar;
...
public class GameScreen extends Base2DScreen implements ActionListener{
    ...
    public void printInfo() {
        ...
        font.draw(batch, sbFrags.append(FRAGS).append(frags), worldBounds.getLeft()+0.01f, worldBounds.getTop() - 0.05f);
        font.draw(batch, sbHP.append(HP).append(mainShip.getHp()), worldBounds.pos.x, worldBounds.getTop() - 0.05f, center);
        font.draw(batch, sbStage.append(STAGE).append(enemiesEmitter.getStage()), worldBounds.getRight()-0.01f, worldBounds.getTop() - 0.05f, right);
    }
